...
Przed wgraniem, jedna decyzja: **16 pozycji `DO WERYFIKACJI`** — wgrać z flagą `do_weryfikacji = true` i przepuścić przez kolejkę roboczą. Lista w `01-analiza-zrodel.md` §1.
